...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch(PlayState.SONG.song.toLowerCase()){
			case 'bliss','happiness','pain','relief':{
				portraitLeft = new FlxSprite(-20, 40);
				switch(PlayState.SONG.song.toLowerCase()){
					case 'bliss','happiness':{
						portraitLeft.frames = Paths.getSparrowAtlas('portraits/vincentportrait', 'shared');
						dadSoundText = 'vincenttext';}
					case 'pain':{
						portraitLeft.frames = Paths.getSparrowAtlas('portraits/evilportrait', 'shared');
						dadSoundText = 'vincenttext';}
					case 'relief':{
						portraitLeft.frames = Paths.getSparrowAtlas('portraits/vincentportrait', 'shared');
						dadSoundText = 'vincenttext';}
