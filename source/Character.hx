...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'vincent':
				frames = Paths.getSparrowAtlas('characters/vincent');
				...
				addOffset('idle');
				addOffset("singUP", 15, 47);
				addOffset("singRIGHT", 7, 19);
				addOffset("singLEFT", 15, 12);
				addOffset("singDOWN", 20, -15);
					
				playAnim('idle');

			case 'twin':
				frames = Paths.getSparrowAtlas('characters/vincenteviltwin_assets');
				animation.addByPrefix('idle', 'idle', 24, false);
				...
				addOffset('idle');
				addOffset("singUP", 19, 48);
				addOffset("singRIGHT", 0, 23);
				addOffset("singLEFT", 15, 21);
				addOffset("singDOWN", 9, -6);
