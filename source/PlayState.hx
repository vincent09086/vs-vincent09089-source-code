...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'bliss':
				dialogue = CoolUtil.coolTextFile(Paths.txt('bliss/dialog'));
			case 'happiness':
				dialogue = CoolUtil.coolTextFile(Paths.txt('happiness/dialog'));
			case 'pain':
				dialogue = CoolUtil.coolTextFile(Paths.txt('pain/dialog'));
			case 'relief':
				dialogue = CoolUtil.coolTextFile(Paths.txt('relief/dialog'));
		}
			...
			case 'room':
				{
					defaultCamZoom = 0.9;
					curStage = 'room';
					var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('raccoon/stageback','shared'));
					bg.antialiasing = true;
					bg.active = false;
					add(bg);
	
					var stageFront:FlxSprite = new FlxSprite(-600, 700).loadGraphic(Paths.image('raccoon/stagefront','shared'));
					stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
					stageFront.updateHitbox();
					stageFront.antialiasing = true;
					stageFront.scrollFactor.set(0.1, 0.1);
					stageFront.active = false;
					add(stageFront);
			...
			case 'roomdestroyed':
				{
					defaultCamZoom = 0.9;
					curStage = 'room';
					var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('raccoon/roomdestroyed','shared'));
					bg.antialiasing = true;
					bg.active = false;
					add(bg);
			...
			case 'roommornin':
				{
					defaultCamZoom = 0.9;
					curStage = 'room';
					var bg:FlxSprite = new FlxSprite(-1000, -500).loadGraphic(Paths.image('raccoon/bgmornin','shared'));
					bg.antialiasing = true;
					bg.active = false;
					add(bg);
